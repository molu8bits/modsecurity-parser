...
<p>
The first idea to create the tool was to get some helping tool to quickly get overview of security incidents recorded by modsecurity into big modsec_audit.log files.
</p>
